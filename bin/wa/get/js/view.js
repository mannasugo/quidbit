...
let Models = {
  ...
  init: {
    ...
    detail: (Arg) => {
      ...
      return [`p`, {style: {display: `flex`, [`font-family`]: `insvg`, padding: 0}}, 
        [[`span`, {style: {[`font-weight`]: 300, opacity: 1, [`margin-right`]: `${4}px`}}, Arg[0]], 
        [`span`, {}, `Open:`], 
        [`span`, {class: `dA`}, `${Arg[1]}`], 
        [`span`, {}, `High:`], 
        [`span`, {class: `dA`}, `${Arg[2]}`], 
  ...
  inputSwap: function (Arg) {
    ...
    return [`div`, {id: `XBB`, style: {[`border-left`]: `${1}px solid #353535`, [`font-family`]: `insvg`, [`font-size`]: `${10.88}px`, height: `${100}%`, width: `${90}%`}}, 
      [[`section`, {style: {height: ``}}, 
        [[`div`, {style: {[`border-bottom`]: `${1}px solid #353535`, padding: `${0}px ${12}px`, width: `${100}%`}}, 
          [[`div`, {class: `_gxM _geQ`}, 
            [[`svg`, {viewbox: `0 0 24 24`, style: {[`align-self`]: `center`, cursor: `pointer`, display: `flex`, height: `${12}px`, [`margin-right`]: `${12}px`, width: `${12}px`}}, 
              [[`path`, {fill: `none`, stroke: `#6bc679`, [`stroke-width`]: 2, d: `M0 12 24 12 M23 4 23 20 M12 4 23 12 12 20`}]]],
  ...
  inputWallet: function (Arg) {
    ...
    Clients.typeWallet = `crypto`;

    let Settype = [`fiat`, `crypto`];

    DOM[1] = [`div`, {id: `viamultiple`, style: {background: `#0b0b48`, display: `none`, position: `absolute`, top: `${28}px`, width: `${100}%`, [`z-index`]: 64}}, []];

    Settype.forEach(type => {

      DOM[1][2].push([`a`, {href: `javascript:;`, style: {[`border-top`]: `1px solid #393939ad`, color: `#fff`, display: `flex`, [`padding`]: `${2}px ${12}px`, width: `${100}%`}}, 
        [[`span`, {style: {opacity: .5, [`text-transform`]: `capitalize`}}, type]]]);
    });
      ...
      [[`div`, {style: {height: `inherit`}}, 
        ...
        [`div`, {style: {padding: `${24}px ${12}px`}}, 
          [[`div`, {class: `_gxM _geQ`, style: {[`margin-bottom`]: `${8}px`}}, 
            ...
            [`div`, {style: {width: `${70}%`}}, 
              [[`div`, {class: `_gxM _geQ`, style: {width: `${100}%`}}, 
                [[`a`, {id: `setVia`, href: `javascript:;`, style: {background: `#242471`, color: `#fff`, display: `flex`, [`padding`]: `${2}px ${12}px`, width: `${100}%`}}, 
                  [[`span`, {}, `Crypto`], 
                  [`div`, {class: `_gZz`}, 
                    [[`svg`, {viewbox: `0 0 24 24`, style: {height: `${8}px`, width: `${8}px`}}, 
          ...
          [`section`, {id: `plus`}], 
          [`div`, {class: `hold-fiat _gxM _geQ`, style: {[`margin-bottom`]: `${8}px`}}, 
                                    [
                                        [`span`, {style: {width: `${30}%`}}, `Token`],
                                        [`div`, {style: {width: `${70}%`}}, 
          ...
          [`div`, {class: `hold-fiat _gxM _geQ`, style: {[`margin-bottom`]: `${22}px`}}, 
                                    [
                                        [`span`, {style: {width: `${30}%`}}, `Funds`],
                                        [`div`, {style: {width: `${70}%`}}, 
                                            [[`div`, {class: `_gxM _geQ`, style: {width: `${100}%`}}, 
          ...
          [`div`, {class: `hold-fiat wallet-out _gxM _geQ`, style: {display: `none`, [`margin-bottom`]: `${8}px`}}, 
                                    [
          ...
          [`div`, {id: `initWallet`, class: `hold-fiat wallet-in _gxM _geQ`, style: {display: (!Arg.wallets.BTC)? `flex`: `none`, [`margin-bottom`]: `${8}px`}}, 
                                    [
                                        [`div`, {style: {width: `${30}%`}}],
                                        [`div`, {style: {width: `${70}%`}}, 
                                            [[`div`, {class: `_gxM _geQ`, style: {width: `${100}%`}}, 
    ...
    return [
      `main`, {id: `plot`, class: `_tY0`, style: {background: `#000`, color: `#fff`, height: `${100}%`}}, 
        [[`div`, {style: {background: `#000`, [`border-bottom`]: `${1}px solid #353535`, height: `${40}px`, padding: `${0}px ${12}px`, width: `${100}%`}}, 
          [[`div`, {class: `_gxM _geQ`}, 
            ...
            [`div`, {class: `_gZz`, style: {[`font-size`]: `${12}px`}}, 
              (!Clients.mug)? [[`a`, {id: `modalMug`, href: `javascript:;`, style: {[`align-content`]: `center`, background: `#6bc679`, color: `#000`, display: `inline-grid`, [`font-family`]: `insvg`, [`font-weight`]: 300, [`font-size`]: `${10.88}px`, padding: `${2}px ${16}px`, [`text-align`]: `center`}}, `SIGN IN`]]: []]]]]],
        ...
        [`section`, {class: `_gxM`, style: {height: `${100}%`, width: `${100}%`}}, 
            ...
            [[`div`, {id: ``, style: {[`border-bottom`]: `${1}px solid #353535`, width: `${100}%`}}, 
              [[`div`, {class: `_gxM _geQ`, style: {[`font-size`]: `${11}px`}}, 
                ...
                [`div`, {class: `_gZz`, style: {height: `${100}%`}}, 
                  [[`div`, {id: `XAC`, class: `_gxM`, style: {[`border-left`]: `${1}px solid #353535`, height: `${100}%`}}, 
                  ...
                  [`div`, {class: `_gxM`, style: {[`border-left`]: `${1}px solid #353535`, height: `${100}%`}}, 
                                            [
                                                ...
                                                [`div`, {style: {background: `#000`, [`border`]: `${1}px solid #353535`, display: `none`, [`font-family`]: `insvg`, [`font-size`]: `${10.88}px`, position: `absolute`, right: `${-1}px`, top: `${36}px`, width: `${360}px`, [`z-index`]: 54}}, [this.inputWallet(Arg)]]]]]]]]]],
          ...
          [`div`, {id: `XB`, class: `_gxM`, style: {background: `#000`, [`border-left`]: `${1}px solid #353535`, height: `${100}%`}}, 
            [[`div`, {style: {width: `${10}%`}}, 
              [[`div`, {style: {[`align-items`]: `center`, display: `none`, height: `${36}px`, [`justify-content`]: `center`, width: `${100}%`}}, 
                [[`svg`, {id: ``, viewbox: `0 0 24 24`, style: {[`align-self`]: `center`, cursor: `pointer`, display: `flex`, height: `${14}px`, width: `${14}px`}}, 
                  [[`path`, {fill: `none`, stroke: `#fff`, [`stroke-width`]: 2, d: `M0 12 24 12 M23 4 23 20 M12 4 23 12 12 20`}]]]]]]], 
            this.inputSwap(Arg.plot)]]]], 
